            ...
            <div class="field relative">
              ...
              <div class="control">
                <select name="penulis" id="penulis"
                  ...
                  <option value="Mahasiswa PMM 4">Mahasiswa PMM 4</option>
                </select>
                <!--<input type="text" name="penulis" id="otherAuthorInput"
                  class="peer absolute top-0 left-0 w-full h-full rounded-[7px] px-3 py-2.5 !border !border-gray-300 border-t-transparent bg-transparent bg-white font-sans text-sm font-normal text-blue-gray-700 shadow-sm shadow-gray-900/5 outline outline-0 ring-4 ring-transparent transition-all placeholder:text-gray-500 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:!border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 focus:ring-gray-900/10 disabled:border-0 disabled:bg-blue-gray-50"
                  style="display: none;" placeholder="Enter other author">-->
              </div>
            </div>

            <!--<script>
              document.getElementById("penulis").addEventListener("change", function () {
                var otherAuthorInput = document.getElementById("otherAuthorInput");
                if (this.value === "other") {
